...
public abstract class CrazySquadsPlayerCommandExecutor extends CrazySquadsCommandExecutor
{

	public CrazySquadsPlayerCommandExecutor(final CrazySquads plugin)
	{
		super(plugin);
	}

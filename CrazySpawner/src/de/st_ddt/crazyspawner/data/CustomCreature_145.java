...
public class CustomCreature_145 implements CustomCreature
{
	...
	public CustomCreature_145(final ConfigurationSection config)
	{
		super();
		...
		this.maxHealth = config.getInt("maxHealth");
		if (LivingEntity.class.isAssignableFrom(clazz))
		{

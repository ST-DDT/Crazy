...
public class CustomCreature_1_4_6 extends CustomCreature_1_4_5
{
	...
	public CustomCreature_1_4_6(final String name, final EntityType type, final int maxHealth, final Collection<Drop> drops, final int minXP, final int maxXP, final ItemStack boots, final float bootsDropChance, final ItemStack leggings, final float leggingsDropChance, final ItemStack chestplate, final float chestplateDropChance, final ItemStack helmet, final float helmetDropChance, final ItemStack itemInHand, final float itemInHandDropChance)
	{
		super(name, type, drops, minXP, maxXP, boots, bootsDropChance, leggings, leggingsDropChance, chestplate, chestplateDropChance, helmet, helmetDropChance, itemInHand, itemInHandDropChance);
		if (Damageable.class.isAssignableFrom(type.getEntityClass()))
			this.maxHealth = maxHealth;
		else
			this.maxHealth = 0;
	...
	{
		super(name, type, drops, minXP, maxXP, boots, bootsDropChance, leggings, leggingsDropChance, chestplate, chestplateDropChance, helmet, helmetDropChance, itemInHand, itemInHandDropChance, passenger);
		if (Damageable.class.isAssignableFrom(type.getEntityClass()))
			this.maxHealth = maxHealth;
		else
			this.maxHealth = 0;
	...
	{
		super(name, type, baby, villager, wither, charged, color, size, angry, tamed, tamer, drops, minXP, maxXP, boots, bootsDropChance, leggings, leggingsDropChance, chestplate, chestplateDropChance, helmet, helmetDropChance, itemInHand, itemInHandDropChance, passenger);
		if (Damageable.class.isAssignableFrom(type.getEntityClass()))
			this.maxHealth = maxHealth;
		else
			this.maxHealth = 0;
	...
	{
		super(name, type, baby, villager, wither, charged, color, size, angry, tamed, tamer, drops, minXP, maxXP, boots, bootsDropChance, leggings, leggingsDropChance, chestplate, chestplateDropChance, helmet, helmetDropChance, itemInHand, itemInHandDropChance, passenger, potionEffects);
		if (Damageable.class.isAssignableFrom(type.getEntityClass()))
			this.maxHealth = maxHealth;
		else
			this.maxHealth = 0;
	...
	public CustomCreature_1_4_6(final String name, final EntityType type, final boolean baby, final boolean villager, final boolean wither, final boolean charged, final DyeColor color, final int size, final boolean angry, final boolean tamed, final OfflinePlayer tamer, final Collection<Drop> drops, final int minXP, final int maxXP, final ItemStack boots, final float bootsDropChance, final ItemStack leggings, final float leggingsDropChance, final ItemStack chestplate, final float chestplateDropChance, final ItemStack helmet, final float helmetDropChance, final ItemStack itemInHand, final float itemInHandDropChance, final ExtendedCreatureType passenger, final Map<? extends PotionEffectType, Integer> potionEffects, final int maxHealth)
	{
		super(name, type, baby, villager, wither, charged, color, size, angry, tamed, tamer, drops, minXP, maxXP, boots, bootsDropChance, leggings, leggingsDropChance, chestplate, chestplateDropChance, helmet, helmetDropChance, itemInHand, itemInHandDropChance, passenger, potionEffects);
		if (Damageable.class.isAssignableFrom(type.getEntityClass()))
			this.maxHealth = maxHealth;

...
public class CustomCreature_1_5 extends CustomCreature_1_4_6
{
	...
	{
		super(name, type, baby, villager, wither, charged, color, size, angry, tamed, tamer, drops, boots, bootsDropChance, leggings, leggingsDropChance, chestplate, chestplateDropChance, helmet, helmetDropChance, itemInHand, itemInHandDropChance, passenger, potionEffects, maxHealth);
		if (LivingEntity.class.isAssignableFrom(type.getEntityClass()))
		{
			this.customName = customName;
			this.showCustomName = showCustomName;

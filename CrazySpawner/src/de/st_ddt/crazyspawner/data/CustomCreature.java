...
public class CustomCreature implements ExtendedCreatureType, ConfigurationSaveable
{
	...
	public CustomCreature(final String name, final EntityType type, final String passenger)
	{
		this(name, type, ExtendedCreatureParamitrisable.getExtendedCreatureType(passenger));
	}

	public CustomCreature(final String name, final EntityType type, final ExtendedCreatureType passenger)
	{
	...
	public CustomCreature(final ConfigurationSection config)
	{
		super();

...
public final class EquipmentProperties extends MetadataProperty implements CustomDrops
{
	...
	public void getCommandParams(final Map<String, ? super TabbedParamitrisable> params, final CommandSender sender)
	{
		...
		params.put("chestplate", chestplateParam);
		params.put("armorchestplate", chestplateParam);
		final DoubleParamitrisable chestplateDropChanceParam = new DoubleParamitrisable(chestplateDropChance);
		params.put("chestplatedc", chestplateDropChanceParam);
		params.put("armorchestplatedc", chestplateDropChanceParam);
		params.put("chestplatedropchance", chestplateDropChanceParam);
		params.put("armorchestplatedropchances", chestplateDropChanceParam);

...
public enum Creatures
{
	...
	CAT(EntityType.OCELOT), CATS(EntityType.OCELOT),
	
	// Golems
	SNOWMAN(EntityType.SNOWMAN), SNOWMEN(EntityType.SNOWMAN), 
	GOLEM(EntityType.IRON_GOLEM), GOLEMS(EntityType.IRON_GOLEM), 
	IRON_GOLEM(EntityType.IRON_GOLEM), IRON_GOLEMS(EntityType.IRON_GOLEM),
	...
	{
		final LivingEntity e = location.getWorld().spawnCreature(location, type);
		switch (this)
		{

...
public enum Creatures
{
	...
	// MagmaSlimes
	MAGMASLIME(EntityType.MAGMA_CUBE),
	MAGMASLIMES(EntityType.MAGMA_CUBE),
	MAGMASLIMETINY(EntityType.MAGMA_CUBE),
	MAGMASLIMESTINY(EntityType.MAGMA_CUBE),
	MAGMASLIMESMALL(EntityType.MAGMA_CUBE),
	MAGMASLIMESSMALL(EntityType.MAGMA_CUBE),
	MAGMASLIMEBIG(EntityType.MAGMA_CUBE),
	MAGMASLIMESBIG(EntityType.MAGMA_CUBE),
	MAGMASLIMEHUGE(EntityType.MAGMA_CUBE),
	MAGMASLIMESHUGE(EntityType.MAGMA_CUBE);

...
public class CrazyOnlineCommandSince extends CrazyOnlineCommandExecutor
{
	...
	@Override
	@Localized({ "CRAZYONLINE.COMMAND.SINCE.HEADER $CurrentPage$ $MaxPage$ $ChatHeader$ $DateTime$ $SinceDateTime$", "CRAZYONLINE.COMMAND.SINCE.LISTFORMAT $Index$ $Entry$ $ChatHeader$", "CRAZYONLINE.COMMAND.SINCE.ENTRYFORMAT $Name$ $FirstLogin$ $LastLogin$ $LastLogout$ $TimeTotalValue$ $IP$ $TimeTotalText$" })
	...
	{
		return PermissionModule.hasPermission(sender, "crazyonline.since");
	}
}

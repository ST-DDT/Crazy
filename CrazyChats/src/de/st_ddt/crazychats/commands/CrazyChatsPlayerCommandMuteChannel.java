...
public class CrazyChatsPlayerCommandMuteChannel extends CrazyChatsPlayerCommandExecutor
{

	public CrazyChatsPlayerCommandMuteChannel(final CrazyChats plugin)
	{
		super(plugin);
	}

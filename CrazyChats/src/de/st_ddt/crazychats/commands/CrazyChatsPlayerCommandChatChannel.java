...
public class CrazyChatsPlayerCommandChatChannel extends CrazyChatsPlayerCommandExecutor
{

	public CrazyChatsPlayerCommandChatChannel(final CrazyChats plugin)
	{
		super(plugin);
	}
